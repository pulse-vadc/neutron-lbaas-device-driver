...
certificate_manager_plugin = neutron_lbaas.common.cert_manager.get_backend()
...
class vTMDeviceDriverCommon(object):
    ...
    def __init__(self):
        ...
        self.certificate_manager = certificate_manager_plugin.CertManager()
...
########
    ...
    def _get_ssl_config(self, vtm, listener):
        ...
        ssl_settings = {
            "server_cert_default": container_id,
            "server_cert_host_mapping": []
        }
        # Upload default certificate
        self._upload_certificate(
            vtm, container_id, listener.tenant_id,
            listener.default_tls_container_id, listener.loadbalancer_id
        )
        ...
        if listener.sni_containers:
            for sni_container in listener.sni_containers:
                ...
                cert = self._upload_certificate(
                    vtm, container_id, listener.tenant_id,
                    sni_container.tls_container_id, listener.loadbalancer_id
                )
    ...
    def _upload_certificate(self, vtm, container_id, tenant_id, container_ref,
                            lb_id):
